...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./TERBO.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S TERBO -X kill
screen -S TERBO ./TERBO
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/TERBOTEAM/Files_Boyka/master/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevTERBOW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevTERBOW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevTERBOW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevTERBOW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevTERBOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevTERBOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevTERBOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true
elseif tonumber(user_id) == tonumber(947425342) then
var = true
...
local UserName = (data.username_ or "SOURCE_TERBO")
...
local TERBO_Msg = ''  
if msgs < 100 then 
TERBO_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
TERBO_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
TERBO_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
TERBO_Msg = 'متفاعل' 
elseif msgs < 1200 then 
TERBO_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
TERBO_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
TERBO_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
TERBO_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
TERBO_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
TERBO_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
TERBO_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
TERBO_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
TERBO_Msg = 'رب التفاعل'  
end 
return TERBO_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceTERBO(msg,data) -- بداية العمل
if msg then
...
if DevTERBOW(msg) then
local bl = ' ♡ اهلا عزيزي آلمـطـور\n ♡ آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n ♡ تسـتطـيع‌‏ آلتحگم باوامر البوت\n ♡ من خلاال الكيبورت خاص بك\n ♡ قناة سورس البوت [اضغط هنا](t.me/SOURCE_TERBO)'
local keyboard = {
...
SourceTERBOr = '♡ اهلا عزيزي\n ♡ انا بوت اسمي '..Namebot..'\n ♡ اختصاصي حمايه المجموعات\n ♡ من تكرار والسبام والتوجيه والخ…\n ♡ لتفعيلي اتبع الاخطوات…↓\n ♡ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ♡ [قناة سورس البوت](http://t.me/SOURCE_TERBO)'
end 
send(msg.chat_id_, msg.id_, SourceTERBOr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevTERBOW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevTERBOW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,TERBO_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ♡' and DevTERBOW(msg) then  
...
if text == 'تعطيل التواصل ♡' and DevTERBOW(msg) then  
...
if text == 'تفعيل البوت الخدمي ♡' and DevTERBOW(msg) then  
...
if text == 'تعطيل البوت الخدمي ♡' and DevTERBOW(msg) then  
...
if text == 'ضع كليشه ستارت ♡' and DevTERBOW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ♡ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ♡' and DevTERBOW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ♡ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ♡' and DevTERBOW(msg) then 
...
if text == 'تحديث السورس ♡' and DevTERBOW(msg) then 
os.execute('rm -rf TERBO.lua')
os.execute('wget https://raw.githubusercontent.com/TERBOTEAM/TERBO/master/TERBO.lua')
send(msg.chat_id_, msg.id_,' ♡ تم تحديث السورس \n ♡ لديك اخر اصدار لسورس تيربو\n ♡ الاصدار » { 1.3v}')
dofile('TERBO.lua')  
end
if text == 'الاصدار ♡' and DevTERBOW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ♡ اصدار سورس تيربو \n ♡ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ♡' and DevTERBOW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ♡ [تحديثات البوت](t.me/SOURCE_TERBO) \n ♡ [قناه السورس](t.me/SOURCE_TERBO)')
end
if text == "ضع اسم للبوت ♡" and DevTERBOW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ♡ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ♡' and DevTERBOW(msg) then 
...
if text == 'المشتركين ♡' and DevTERBOW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ♡ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'المجموعات ♡' and DevTERBOW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ♡ المجموعات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ♡") and DevTERBOW(msg) then
...
if text == ("قائمه العام ♡") and DevTERBOW(msg) then
...
if text == ("قائمه الكتم العام ♡") and DevTERBOW(msg) then
...
if text=="اذاعه خاص ♡" and msg.reply_to_message_id_ == 0 and DevTERBOW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ♡ ارسل الان اذاعتك؟ \n ♡ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ♡" and msg.reply_to_message_id_ == 0 and DevTERBOW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ♡ ارسل الان اذاعتك؟ \n ♡ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ♡" and msg.reply_to_message_id_ == 0 and DevTERBOW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ♡ ارسل الان اذاعتك؟ \n ♡ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ♡" and msg.reply_to_message_id_ == 0  and DevTERBOW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ♡ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ♡" and msg.reply_to_message_id_ == 0  and DevTERBOW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ♡ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ♡' and DevTERBOW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ♡" and DevTERBOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف المجموعات ♡" and DevTERBOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'♡  عدد المجموعات الان » { '..#group..' }'..TERBOk..''..TERBO..'\n♡  الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevTERBOW(msg) then
...
usertext = '\n ♡ العضو » ['..result.title_..'](t.me/'..(username or 'SOURCE_TERBO')..')'
status  = '\n ♡ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevTERBOW(msg) then
...
usertext = '\n ♡ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_TERBO')..')'
status  = '\n ♡ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevTERBOW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevTERBOW(msg) then
...
local TERBO1_Msg = database:get(bot_id.."TERBO1:Add:Filter:Rp2"..text..msg.chat_id_)   
if TERBO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ♡ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_TERBO')..') \n ♡ '..TERBO1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if TERBO_Msg and not Special(msg) then  
local TERBO_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if TERBO_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ♡ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ♡ ["..TERBO_Msg.."] \n")
else
send(msg.chat_id_,0," ♡ العضو : {["..data.first_name_.."](T.ME/SOURCE_TERBO)}\n ♡ ["..TERBO_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ♡ عذرا » {["..data.first_name_.."](T.ME/SOURCE_TERBO)}\n ♡ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevTERBOW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevTERBOW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevTERBOW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ♡ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevTERBOW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ♡ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ♡" and DevTERBOW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ♡ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ♡$") and DevTERBOW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ♡ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ♡" and DevTERBOW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ♡" and DevTERBOW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ♡ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ♡" and DevTERBOW(msg) then  
...
database:sadd(bot_id.."TERBO:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."TERBO:blocname"..msg.chat_id_)
...
if name_Boyka then 
names_Boyka = database:smembers(bot_id.."TERBO:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."TERBO:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."TERBO:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."TERBO:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."TERBO:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."TERBO:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Boykaa_new(Boyka1,Boyka2)
if Boyka2 and Boyka2.first_name_ then 
if Boyka2.first_name_:match("(.*)"..database:get(bot_id.."TERBO:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."TERBO:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Boyka_nnn = database:get(bot_id.."TERBO:nump"..msg.chat_id_) or 5
local Boyka_nnn2 = database:get(bot_id.."TERBO:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Boyka_nnn2) == tonumber(Boyka_nnn) or tonumber(Boyka_nnn2) > tonumber(Boyka_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."TERBO:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "♡ عزيزي >>["..Boyka2.username_.."](https://t.me/"..(Boyka2.username_ or "SOURCE_TERBO")..")\n♡ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."TERBO:teh"..msg.chat_id_).."} بجانب اسمك\n♡ عدد المحاولات المتبقيه {"..(tonumber(Boyka_nnn) - tonumber(Boyka_nnn2)).."}")
end
end
end
end
...
local TERBOChengName = database:get(bot_id.."TERBO:Cheng:Name"..data.id_)
if not data.first_name_ then 
if TERBOChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..TERBOChengName..']')
database:del(bot_id.."TERBO:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if TERBOChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."TERBO:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local TERBOChengUserName = database:get(bot_id.."TERBO:Cheng:UserName"..data.id_)
if not data.username_ then 
if TERBOChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..TERBOChengUserName..']')
database:del(bot_id.."TERBO:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if TERBOChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."TERBO:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local TERBOChengPhoto = database:get(bot_id.."TERBO:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if TERBOChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."TERBO:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if TERBOChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."TERBO:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
{{text = ' Channel ',url="t.me/SOURCE_TERBO"}}, 
{{text = ' Developer¹ ', url="t.me/SIRIA199"}}, 
{{text =  ' Developer² ', url="t.me/ALMOFTARESs"}}, 
...
if text == 'رفع نسخه الاحتياطيه' and DevTERBOW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ♡ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_TERBO')..') \n ♡ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ♡ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SOURCE_TERBO')..') \n ♡ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevTERBOW(msg) then    
dofile('TERBO.lua')  
send(msg.chat_id_, msg.id_, ' ♡ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevTERBOW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevTERBOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevTERBOW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevTERBOW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevTERBOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevTERBOW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevTERBOW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevTERBOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevTERBOW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevTERBOW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevTERBOW(msg) then
...
if text == 'الملفات' and DevTERBOW(msg) then
...
if DevTERBOW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TERBOTEAM/Files_Boyka/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ♡ اهلا بك في متجر ملفات تيربو\n ♡ ملفات السورس ↓\n≪━━━━━━TERBO━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━TERBO━━━━━━≫\n ♡ علامة تعني { ✓ } ملف مفعل\n ♡ علامة تعني { ✘ } ملف معطل\n ♡ قناة سورس تيربو ↓\n".." ♡ [اضغط هنا لدخول](t.me/SOURCE_TERBO) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevTERBOW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/TERBOTEAM/Files_Boyka/master/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevTERBOW(msg) then
...
if text == "مسح الملفات" and DevTERBOW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ♡ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevTERBOW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevTERBOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "SOURCE_TERBO")
...
function Function_TERBO(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TERBO, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_TERBO, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ♡ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_TERBO')..')'
status  = '\n ♡ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ♡ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ♡ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_TERBO')..')'
...
database:set(bot_id.."TERBO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."TERBO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ♡ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."TERBO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."TERBO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."TERBO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."TERBO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ♡ تم منع الكلمه مع التحذير")  
database:del(bot_id.."TERBO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."TERBO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."TERBO1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."TERBO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ♡ ارسل الكلمه الان")  
database:set(bot_id.."TERBO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."TERBO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."TERBO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TERBO1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."TERBO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."TERBO1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."TERBO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TERBO1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."TERBO1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ♡ قائمة المنع \n≪━━━━━━TERBO━━━━━━≫\n"
for k,v in pairs(list) do  
local TERBO_Msg = database:get(bot_id.."TERBO1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..TERBO_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevTERBOW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ♡ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevTERBOW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ♡ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SOURCE_TERBO')..')'..'\n ♡ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevTERBOW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevTERBOW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..TERBO_Msg[math.random(#TERBO_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevTERBOW(msg) then 
...
if text == ("مسح ردود المطور") and DevTERBOW(msg) then 
...
if text == ("ردود المطور") and DevTERBOW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ♡ قائمة ردود المطور \n≪━━━━━━TERBO━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevTERBOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevTERBOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevTERBOW(msg) then   
...
if text == 'تعطيل المغادره' and DevTERBOW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n♡ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TERBO')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_TERBO')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
TERBOdx(msg.chat_id_, msg.id_, ' ♡ ايدي المجموعة » ( '..msg.chat_id_..' )\n ♡ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ♡ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ♡ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevTERBOW(msg) then
...
*♡م10 ◂ اوامر الاعضاء*
ٴ≪━━━━━━TERBO━━━━━━≫ٴ
彡 .[TERBO CHANNEL](t.me/SOURCE_TERBO)➢ 
]]
...
send(msg.chat_id_, msg.id_, t..'ٴ♡ٴ≪━━━━━━TERBO━━━━━━≫ٴ♡○ٴ\n♡ 彡 .[TERBO CHANNEL](t.me/SOURCE_TERBO)➢ ')
end
...
TERBO = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(TERBO)
...
--------------------------------------------------------------------------------------------------------------
SourceTERBO(data.message_,data)
...
------------------------------------------------------------------------
local TERBOAbot = database:get(bot_id.."TERBO1:Add:Filter:Rp2"..text..result.chat_id_)   
if TERBOAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ♡ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ♡ ["..TERBOAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local TERBO1_Msg = database:get(bot_id.."TERBO1:Add:Filter:Rp2"..text..result.chat_id_)   
if TERBO1_Msg then    
send(msg.chat_id_, msg.id_," ♡ "..TERBO1_Msg)
